...
With `run` = `noSearch` or `noRead`, the package checks fine both on my local computer and on GitHub. With `run` = any of the other three, the package checks fine locally but fails with GitHub Action on all 5 platforms. 
